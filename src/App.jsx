...
export default function App() {
  ...
  /*
   * IMPORTANT:
   * الباب كيبقى محلول من بعد أول فتح.
   */
    ...
    <div className="page">
      ...
      >
        ...
        <div className="gate-background">
          ...
          >
            <span className="gate-button-star">
              ✦
            </span>
        ...
        <div className="gate-door gate-door-left">
          ...
          <div className="gate-door-inner">
            ...
            <div className="gate-pattern">
              ...
              <div className="gate-diamond diamond-1" />
              <div className="gate-diamond diamond-2" />
              <div className="gate-diamond diamond-3" />
        ...
        <div className="gate-frame">
          ...
          <div className="gate-frame-left" />
          <div className="gate-frame-right" />
